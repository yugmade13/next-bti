...
const columns = [
  ...
  { name: "Place of Birth", uid: "pob", sortable: true },
  { name: "Date of Birth", uid: "dob", sortable: true },
  { name: "Religion", uid: "religion", sortable: true },
  { name: "Address", uid: "address", sortable: true },
  { name: "ACTIONS", uid: "actions" },
];

const INITIAL_VISIBLE_COLUMNS = ["id", "name", "nisn", "email", "phone", "actions"];
        ...
        return (
          <div className="relative flex justify-center items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem onClick={() => router.push(`/${student.id}/edit`)}>
                  Edit
                </DropdownItem>
                <DropdownItem onClick={() => handleDelete(student.id)} className="text-danger">
                  Delete
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
